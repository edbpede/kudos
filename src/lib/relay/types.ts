import type { ClassroomSession, DisplayState, TeacherPreferences } from "../domain/types";
...
export interface LiveRelay {
  create(session: ClassroomSession, ttlSeconds: number): Promise<LiveSessionCreated>;
